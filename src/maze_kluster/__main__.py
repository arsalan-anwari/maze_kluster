...
def main() -> None:
    ...
    tui_parser.add_argument("--bot", type=str, default="baseline", help="Bot name from BOTS registry")  # noqa: E501
    tui_parser.add_argument("--replay", type=str, default=None, metavar="PATH", help="Path to JSONL run log for replay")  # noqa: E501
    tui_parser.add_argument("--theme", type=str, default=None, metavar="THEME_NAME", help="TUI colour theme (see --list-themes)")  # noqa: E501
    tui_parser.add_argument("--connection", type=str, default="connection.json", metavar="PATH", help="Path to connection.json with API credentials")  # noqa: E501
    tui_parser.add_argument("--list-mazes", action="store_true", help="Print available maze names and exit")  # noqa: E501
    tui_parser.add_argument("--list-themes", action="store_true", help="Print available theme names and exit")  # noqa: E501
